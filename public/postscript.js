;(function () {
  // quartz/components/scripts/quartz/components/scripts/clipboard.inline.ts
  var svgCopy =
      ...
      ;(function _f(self) {
        ...
        function ca(a2, b2) {
          ...
          if (
            a2 &&
            (b2 && (a2 = E(a2, b2)),
            this.H && (a2 = E(a2, this.H)),
            this.J && 1 < a2.length && (a2 = E(a2, this.J)),
            c2 || "" === c2)
          ) {
            a2 = a2.split(c2)
            if (this.filter) {
        ...
        function E(a2, b2) {
          for (
            let c2 = 0, d2 = b2.length;
            c2 < d2 && ((a2 = a2.replace(b2[c2], b2[c2 + 1])), a2);
            c2 += 2
          );
          return a2
        }
        ...
        const qa = {
          memory: { charset: "latin:extra", D: 3, B: 4, m: false },
          performance: { D: 3, B: 3, s: false, context: { depth: 2, D: 1 } },
                  ...
                  switch (this.G) {
                    ...
                    case "reverse":
                      if (2 < e) {
                        for (h = e - 1; 0 < h; h--)
                          (g = l[h] + g),
                            g.length >= this.B && M(this, n, g, L(q, d2, r, e, h), a2, c2)
                        g = ""
                      }
                    case "forward":
                      if (1 < e) {
                    ...
                    default:
                      if (
                        (this.C && (f = Math.min((f / this.C(b2, l, r)) | 0, q - 1)),
                        M(this, n, l, f, a2, c2),
                        w && 1 < d2 && r < d2 - 1)
                      ) {
                        for (
                          e = v(), g = this.A, f = l, h = Math.min(w + 1, d2 - r), e[f] = 1, k = 1;
                          k < h;
                          k++
                        )
                          if (
                            (l = b2[this.F ? d2 - 1 - r - k : r + k]) &&
                            l.length >= this.B &&
                            !e[l]
                          ) {
                            e[l] = 1
        ...
        function M(a2, b2, c2, d2, e, f, g) {
          ...
          if (!b2[c2] || (g && !b2[c2][g]))
            a2.s && (h = h[d2]),
              g
                ? ((b2 = b2[c2] || (b2[c2] = v())), (b2[g] = 1), (h = h[g] || (h[g] = v())))
                : (b2[c2] = 1),
              (h = h[c2] || (h[c2] = [])),
              a2.s || (h = h[d2] || (h[d2] = [])),
              (f && -1 !== h.indexOf(e)) ||
                ((h[h.length] = e),
                a2.m && ((a2 = a2.register[e] || (a2.register[e] = [])), (a2[a2.length] = h)))
        }
        t.search = function (a2, b2, c2) {
          ...
          if (a2 && ((a2 = this.encode(a2)), (e = a2.length), 1 < e)) {
            ...
            for (let n = 0, w = 0, q; n < e; n++)
              if ((q = a2[n]) && q.length >= this.B && !c2[q])
                if (this.s || f || this.map[q]) (k[w++] = q), (c2[q] = 1)
                else return d2
            a2 = k
            e = a2.length
          }
          ...
          for (let n, w; c2 < e; c2++) {
            w = a2[c2]
            h
              ? ((n = sa(this, d2, f, b2, g, 2 === e, w, m)),
                (f && false === n && d2.length) || (m = w))
              : (n = sa(this, d2, f, b2, g, 1 === e, w))
            if (n) return n
            if (f && c2 === e - 1) {
              k = d2.length
              if (!k) {
        ...
        function sa(a2, b2, c2, d2, e, f, g, h) {
          ...
          if (m) {
            ...
            for (let q = 0, r = 0, l, p; q < w; q++)
              if ((l = m[q])) {
                if (
                  (a2.s && (l = ua(l, g, h, a2.l)),
                  e &&
                    l &&
                    f &&
                    ((p = l.length), p <= e ? ((e -= p), (l = null)) : ((l = l.slice(e)), (e = 0))),
                  l && ((k[n++] = l), f && ((r += l.length), r >= d2)))
                )
                  break
              }
            if (n) {
        ...
        function ua(a2, b2, c2, d2) {
          c2
            ? ((d2 = d2 && b2 > c2), (a2 = (a2 = a2[d2 ? b2 : c2]) && a2[d2 ? c2 : b2]))
            : (a2 = a2[b2])
          return a2
        }
        ...
        t.remove = function (a2, b2) {
          ...
          if (c2) {
            if (this.m)
              for (let d2 = 0, e; d2 < c2.length; d2++) (e = c2[d2]), e.splice(e.indexOf(a2), 1)
            ...
            if (this.cache) {
              ...
              for (let d2 = 0, e, f; d2 < b2.h.length; d2++)
                (f = b2.h[d2]),
                  (e = b2.cache[f]),
                  -1 !== e.indexOf(a2) && (b2.h.splice(d2--, 1), delete b2.cache[f])
            }
          }
          return this
        }
        function N(a2, b2, c2, d2, e) {
          ...
          if (a2.constructor === Array)
            if (e) (b2 = a2.indexOf(b2)), -1 !== b2 ? 1 < a2.length && (a2.splice(b2, 1), f++) : f++
            else {
              e = Math.min(a2.length, c2)
              for (let g = 0, h; g < e; g++)
                if ((h = a2[g])) (f = N(h, b2, c2, d2, e)), d2 || f || delete a2[g]
            }
        ...
        function va(a2) {
          ...
          switch (d2) {
            case "init":
              ...
              a2
                ? (Function("return " + a2)()(self),
                  (self._index = new self.FlexSearch.Index(d2)),
                  delete self.FlexSearch)
                : (self._index = new K(d2))
              break
            default:
              ;(a2 = a2.id),
                (b2 = b2[d2].apply(b2, c2)),
                postMessage("search" === d2 ? { id: a2, msg: b2 } : { id: a2 })
          }
        }
        let wa = 0
        function O(a2) {
          ...
          try {
            d = b
              ...
              : a
                ? new Worker(
                    URL.createObjectURL(
                      new Blob(["onmessage=" + va.toString()], { type: "text/javascript" }),
                    ),
                  )
        ...
        function Q(a2) {
          ...
          for (let e = 0, f, g; e < d2.length; e++)
            (f = d2[e]),
              x(f) || ((g = f), (f = f.field)),
              (g = C(g) ? Object.assign({}, a2, g) : a2),
              this.o && ((c2[f] = new O(g)), c2[f].o || (this.o = false)),
              this.o || (c2[f] = new K(g, this.register)),
              (this.K[e] = S(f, this.A)),
              (this.h[e] = f)
          if (this.C)
        ...
        function S(a2, b2) {
          ...
          for (let e = 0; e < c2.length; e++)
            (a2 = c2[e]),
              0 <= a2.indexOf("[]") && (a2 = a2.substring(0, a2.length - 2)) && (b2[d2] = true),
              a2 && (c2[d2++] = a2)
        ...
        function U(a2, b2, c2, d2, e) {
          ...
          if (d2 === c2.length - 1) b2[e] = a2
            ...
            if (a2.constructor === Array)
              for (b2 = b2[e] = Array(a2.length), e = 0; e < a2.length; e++) U(a2, b2, c2, d2, e)
        ...
        function V(a2, b2, c2, d2, e, f, g, h) {
          if ((a2 = a2[g]))
            if (d2 === b2.length - 1) {
              ...
              for (g = 0; g < a2.length; g++) V(a2, b2, c2, d2, e, f, g, h)
          ...
          if (b2 && (a2 || 0 === a2)) {
            ...
            for (let d2 = 0, e, f; d2 < this.h.length; d2++)
              (f = this.h[d2]),
                (e = this.K[d2]),
                x(e) && (e = [e]),
                V(b2, e, this.A, 0, this.index[f], a2, e[0], c2)
            if (this.I) {
              let d2 = T(b2, this.I),
                e = v()
              x(d2) && (d2 = [d2])
              for (let f = 0, g, h; f < d2.length; f++)
                if (
                  ((g = d2[f]),
                  !e[g] &&
                    ((e[g] = 1), (h = this.l[g] || (this.l[g] = [])), !c2 || -1 === h.indexOf(a2)))
                ) {
        ...
        t.remove = function (a2) {
          ...
          if (this.register[a2]) {
            for (
              var b2 = 0;
              b2 < this.h.length && (this.index[this.h[b2]].remove(a2, !this.o), !this.m);
              b2++
            );
            if (this.I && !this.m)
        ...
        t.search = function (a2, b2, c2, d2) {
          ...
          let e = [],
            ...
            q = 0
          if (c2)
            if (c2.constructor === Array) (k = c2), (c2 = null)
            else {
              ...
              if (m && (x(m) && (m = [m]), !a2)) {
                for (let l = 0, p; l < m.length; l++)
                  if ((p = ya.call(this, m[l], b2, w, h))) (e[e.length] = p), q++
                return q ? e : []
              }
              x(k) && (k = [k])
            }
        ...
        t.export = function (a2, b2, c2, d2, e) {
          ...
          if (d2 < this.h.length) {
            ...
            b2 = this
            setTimeout(function () {
              g.export(a2, b2, e ? f.replace(":", "-") : "", d2, e++) ||
                (d2++, (e = 1), b2.export(a2, b2, f, d2, e))
            })
          } else {
            let f
            switch (e) {
        ...
        const Ca = [
          F("[\xE0\xE1\xE2\xE3\xE4\xE5]"),
          "a",
          F("[\xE8\xE9\xEA\xEB]"),
          "e",
          F("[\xEC\xED\xEE\xEF]"),
          "i",
          F("[\xF2\xF3\xF4\xF5\xF6\u0151]"),
          "o",
          F("[\xF9\xFA\xFB\xFC\u0171]"),
          "u",
          F("[\xFD\u0177\xFF]"),
        ...
        function Ha(a2, b2) {
          a2 &&
            ((a2 = Da.call(this, a2).join(" ")),
            2 < a2.length && (a2 = E(a2, Ja)),
            b2 || (1 < a2.length && (a2 = ha(a2)), a2 && (a2 = a2.split(" "))))
          return a2
        }
        ...
        function Ka(a2) {
          a2 &&
            ((a2 = Ha.call(this, a2, true)),
            1 < a2.length && (a2 = a2.replace(Ma, "")),
            1 < a2.length && (a2 = ha(a2)),
            a2 && (a2 = a2.split(" ")))
          return a2
        }
        G["latin:default"] = ja
  ...
  document.addEventListener("nav", async (e) => {
    ...
    const formatForDisplay = (term, id) => {
      ...
      return {
        ...
        content:
          searchType === "tags"
            ? trimContent(data[slug2].content)
            : highlight(term, data[slug2].content ?? "", true),
...
;(function () {
  // quartz/components/scripts/quartz/components/scripts/toc.inline.ts
...
;(function () {
  ...
  function getWindowScrollBarX(element) {
    return (
      getBoundingClientRect(getDocumentElement(element)).left + getNodeScroll(element).scrollLeft
    )
  }
...
;(function () {
  ...
  async function O(e, t, r) {
    ...
    let n
    switch (
      (e.nodeType === 9 ? ((e = e.documentElement), (n = e)) : r ? (n = r) : (n = e), t.type)
    ) {
      case 0: {
        let { node: o } = t
        e.appendChild(o)
